...
public static class MovementJointMatch
{
    ...
    static MovementJointMatch()
    {
        ...
        movementJointMatch.Add(new MovementLimbKey(Movement.AbducciónDeCaderaEnDecúbitoLateral, Laterality.Single, Limb.Left), new JointTypePlanoResult(ArticulacionType.MusloIzquierda, Plano.planos.planoHorizontalAcostado));
        movementJointMatch.Add(new MovementLimbKey(Movement.AbducciónDeCaderaEnDecúbitoLateral, Laterality.Single, Limb.Right), new JointTypePlanoResult(ArticulacionType.MusloDerecha, Plano.planos.planoHorizontalAcostado));
        ...
        movementJointMatch.Add(new MovementLimbKey(Movement.ElevaciónResistidaDeHombrosEnPlanoEscapular_Bilateral, Laterality.Double, Limb.None), new JointTypePlanoResult(ArticulacionType.BrazoIzquierdo, Plano.planos.planoFrontal));
        ...
        movementJointMatch.Add(new MovementLimbKey(Movement.ExtensiónDeCaderaEnProno, Laterality.Single, Limb.Left), new JointTypePlanoResult(ArticulacionType.PiernaIzquierda, Plano.planos.planoHorizontalAcostado));
        movementJointMatch.Add(new MovementLimbKey(Movement.ExtensiónDeCaderaEnProno, Laterality.Single, Limb.Right), new JointTypePlanoResult(ArticulacionType.PiernaDerecha, Plano.planos.planoHorizontalAcostado));
        ...
        movementJointMatch.Add(new MovementLimbKey(Movement.ExtensiónDeHombroConFlexiónDeCodo_RemoHorizontalBípedo45ºF_45_BIPEDO, Laterality.Single, Limb.Left), new JointTypePlanoResult(ArticulacionType.BrazoIzquierdo, Plano.planos.planoSagital));
        movementJointMatch.Add(new MovementLimbKey(Movement.ExtensiónDeHombroConFlexiónDeCodo_RemoHorizontalBípedo45ºF_45_BIPEDO, Laterality.Single, Limb.Right), new JointTypePlanoResult(ArticulacionType.BrazoDerecho, Plano.planos.planoSagital));

        movementJointMatch.Add(new MovementLimbKey(Movement.ExtensiónDeHombroConFlexiónDeCodo_RemoHorizontalBípedo90ºF_90_BIPEDO, Laterality.Single, Limb.Left), new JointTypePlanoResult(ArticulacionType.BrazoIzquierdo, Plano.planos.planoSagital));
        movementJointMatch.Add(new MovementLimbKey(Movement.ExtensiónDeHombroConFlexiónDeCodo_RemoHorizontalBípedo90ºF_90_BIPEDO, Laterality.Single, Limb.Right), new JointTypePlanoResult(ArticulacionType.BrazoDerecho, Plano.planos.planoSagital));

        movementJointMatch.Add(new MovementLimbKey(Movement.ExtensiónDeHombroConFlexiónDeCodo_RemoHorizontalProno_90_PRONO, Laterality.Single, Limb.Left), new JointTypePlanoResult(ArticulacionType.BrazoIzquierdo, Plano.planos.planoSagital));
        movementJointMatch.Add(new MovementLimbKey(Movement.ExtensiónDeHombroConFlexiónDeCodo_RemoHorizontalProno_90_PRONO, Laterality.Single, Limb.Right), new JointTypePlanoResult(ArticulacionType.BrazoDerecho, Plano.planos.planoSagital));

        movementJointMatch.Add(new MovementLimbKey(Movement.ExtensiónDeHombroConFlexiónDeCodoEnBípedo_Unilateral_45, Laterality.Single, Limb.Left), new JointTypePlanoResult(ArticulacionType.BrazoIzquierdo, Plano.planos.planoSagital));
        movementJointMatch.Add(new MovementLimbKey(Movement.ExtensiónDeHombroConFlexiónDeCodoEnBípedo_Unilateral_45, Laterality.Single, Limb.Right), new JointTypePlanoResult(ArticulacionType.BrazoDerecho, Plano.planos.planoSagital));

        movementJointMatch.Add(new MovementLimbKey(Movement.ExtensiónDeHombroConFlexiónDeCodoEnBípedo_Unilateral_90, Laterality.Single, Limb.Left), new JointTypePlanoResult(ArticulacionType.BrazoIzquierdo, Plano.planos.planoSagital));
        movementJointMatch.Add(new MovementLimbKey(Movement.ExtensiónDeHombroConFlexiónDeCodoEnBípedo_Unilateral_90, Laterality.Single, Limb.Right), new JointTypePlanoResult(ArticulacionType.BrazoDerecho, Plano.planos.planoSagital));

        movementJointMatch.Add(new MovementLimbKey(Movement.ExtensiónDeHombrosConEstabilizaciónEscapular_Bilateral_45, Laterality.Double, Limb.None), new JointTypePlanoResult(ArticulacionType.BrazoIzquierdo, Plano.planos.planoSagital));
        movementJointMatch.Add(new MovementLimbKey(Movement.ExtensiónDeHombrosConEstabilizaciónEscapular_Bilateral_60, Laterality.Double, Limb.None), new JointTypePlanoResult(ArticulacionType.BrazoIzquierdo, Plano.planos.planoSagital));
        movementJointMatch.Add(new MovementLimbKey(Movement.ExtensiónDeHombrosConEstabilizaciónEscapular_Bilateral_90, Laterality.Double, Limb.None), new JointTypePlanoResult(ArticulacionType.BrazoIzquierdo, Plano.planos.planoSagital));

        movementJointMatch.Add(new MovementLimbKey(Movement.ExtensiónDeHombrosConFlexiónDeCodosEnBípedo_Bilateral_45, Laterality.Double, Limb.None), new JointTypePlanoResult(ArticulacionType.BrazoIzquierdo, Plano.planos.planoSagital));
        movementJointMatch.Add(new MovementLimbKey(Movement.ExtensiónDeHombrosConFlexiónDeCodosEnBípedo_Bilateral_90, Laterality.Double, Limb.None), new JointTypePlanoResult(ArticulacionType.BrazoIzquierdo, Plano.planos.planoSagital));
        ...
        movementJointMatch.Add(new MovementLimbKey(Movement.FlexiónDeHombroConExtensiónDeCodoEnBípedo_Unilateral_45, Laterality.Single, Limb.Left), new JointTypePlanoResult(ArticulacionType.BrazoIzquierdo, Plano.planos.planoSagital));
        movementJointMatch.Add(new MovementLimbKey(Movement.FlexiónDeHombroConExtensiónDeCodoEnBípedo_Unilateral_45, Laterality.Single, Limb.Right), new JointTypePlanoResult(ArticulacionType.BrazoDerecho, Plano.planos.planoSagital));

        movementJointMatch.Add(new MovementLimbKey(Movement.FlexiónDeHombroConExtensiónDeCodoEnBípedo_Unilateral_90, Laterality.Single, Limb.Left), new JointTypePlanoResult(ArticulacionType.BrazoIzquierdo, Plano.planos.planoSagital));
        movementJointMatch.Add(new MovementLimbKey(Movement.FlexiónDeHombroConExtensiónDeCodoEnBípedo_Unilateral_90, Laterality.Single, Limb.Right), new JointTypePlanoResult(ArticulacionType.BrazoDerecho, Plano.planos.planoSagital));

        movementJointMatch.Add(new MovementLimbKey(Movement.FlexiónDeHombrosConExtensiónDeCodosEnBípedo_Bilateral_45, Laterality.Double, Limb.None), new JointTypePlanoResult(ArticulacionType.BrazoIzquierdo, Plano.planos.planoSagital));
        movementJointMatch.Add(new MovementLimbKey(Movement.FlexiónDeHombrosConExtensiónDeCodosEnBípedo_Bilateral_90, Laterality.Double, Limb.None), new JointTypePlanoResult(ArticulacionType.BrazoIzquierdo, Plano.planos.planoSagital));
        ...
        movementJointMatch.Add(new MovementLimbKey(Movement.RetracciónEscapularEnBípedoCon45ºFlexiónDeTronco_45_BIPEDO, Laterality.Single, Limb.Left), new JointTypePlanoResult(ArticulacionType.BrazoIzquierdo, Plano.planos.planoSagital));
        movementJointMatch.Add(new MovementLimbKey(Movement.RetracciónEscapularEnBípedoCon45ºFlexiónDeTronco_45_BIPEDO, Laterality.Single, Limb.Right), new JointTypePlanoResult(ArticulacionType.BrazoDerecho, Plano.planos.planoSagital));

        movementJointMatch.Add(new MovementLimbKey(Movement.RetracciónEscapularEnBípedoCon90ºFlexiónDeTronco_90_BIPEDO, Laterality.Single, Limb.Left), new JointTypePlanoResult(ArticulacionType.BrazoIzquierdo, Plano.planos.planoSagital));
        movementJointMatch.Add(new MovementLimbKey(Movement.RetracciónEscapularEnBípedoCon90ºFlexiónDeTronco_90_BIPEDO, Laterality.Single, Limb.Right), new JointTypePlanoResult(ArticulacionType.BrazoDerecho, Plano.planos.planoSagital));

        movementJointMatch.Add(new MovementLimbKey(Movement.RetracciónEscapularEnProno_90_PRONO, Laterality.Single, Limb.Left), new JointTypePlanoResult(ArticulacionType.BrazoIzquierdo, Plano.planos.planoSagital));
        movementJointMatch.Add(new MovementLimbKey(Movement.RetracciónEscapularEnProno_90_PRONO, Laterality.Single, Limb.Right), new JointTypePlanoResult(ArticulacionType.BrazoDerecho, Plano.planos.planoSagital));
        ...
        movementJointMatch.Add(new MovementLimbKey(Movement.SaltoBipodalLlevandoRodillasAlPecho_FLEX_ROD, Laterality.Double, Limb.None), new JointTypePlanoResult(ArticulacionType.PiernaIzquierda, Plano.planos.planoSagital));
        ...
        movementJointMatch.Add(new MovementLimbKey(Movement.FlexiónHorizontalResistidaDeHombros_BípedoBilateral, Laterality.Double, Limb.None), new JointTypePlanoResult(ArticulacionType.HombroIzquierdo, Plano.planos.planoFrontal));
